  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled || !isHome
          ? "bg-beige/95 backdrop-blur-sm border-b border-grey-200"
          : "bg-transparent"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <Link
            href="/"
            className="font-display text-2xl md:text-3xl tracking-tight text-grey-900 hover:text-burgundy transition-colors"
          >
            RHYAN LOVELL
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4 ml-4 pl-4 border-l border-grey-300">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden text-grey-900 p-2"
